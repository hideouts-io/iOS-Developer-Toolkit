...
def command_presets() -> tuple[CommandPreset, ...]:
    ...
    return (
        ...
        CommandPreset("dvt-netstat", "DVT network activity", "Developer & DVT", "Stream DVT network-connection events until stopped.", "This is an event stream, not a point-in-time snapshot or packet capture. Use Stop when the observation window ends, then correlate events with PCAP and logs for attribution.", ("developer", "dvt", "netstat"), (), "read-only", True, True, True, ("developer", "dvt", "netstat")),
        ...
        CommandPreset("core-apps", "CoreDevice applications", "Developer & DVT", "Request applications through the CoreDevice app stream.", "iOS 26-era DDIs may keep the underlying stream open instead of returning a finite snapshot. Use Stop if service completion does not arrive, and compare with Installation Proxy and DVT application inventory.", ("developer", "core-device", "list-apps"), (), "read-only", True, True, True, ("developer", "core-device", "list-apps")),
